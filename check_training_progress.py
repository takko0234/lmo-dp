...
if __name__ == "__main__":
    jsonfile = "../2.good_results/task1/jsonfiles/MNLI-matched@BERT-base@Gaussian_Noise@0.3@.json"
    # jsonfile = "../2.good_results/task1/jsonfiles/SST-2@BERT-base@Gaussian_Noise@0.3@.json"
    # jsonfile = "../2.good_results/task1/jsonfiles/QNLI@BERT-base@Gaussian_Noise@0.3@.json"
    # jsonfile = "../2.good_results/task1/jsonfiles/QQP@BERT-base@Gaussian_Noise@0.3@.json"
